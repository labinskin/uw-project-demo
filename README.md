...
The database schema can be found [here](https://github.com/labinskin/uw-project-demo/blob/main/Data/schema.sql).  
Our ERD can be viewed [here](https://github.com/labinskin/uw-project-demo/blob/main/Data/ERD.png).
